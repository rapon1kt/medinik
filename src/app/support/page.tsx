			...
			>
				<Stack sx={{ textAlign: "center", height: "20%", gap: 3 }}>
					<Typography
						...
						className="logo"
						sx={{
							background: "linear-gradient(120deg, #710000, #cf0034, #bf2626)",
					...
					>
						...
						<Box sx={{ width: "90%" }}>
							...
							<Typography
								...
								sx={{ textAlign: "justify" }}
							>
								After the download is complete, locate the installation file on
								your computer. It will usually be in your browser's downloads
								folder or default downloads location. Double-click the file to
								start the installation process.
							</Typography>
							<Typography level="body-md">
								• <strong>Step 3: </strong> Follow the Installation Instructions
							</Typography>
							<Typography
								gutterBottom
								level="body-sm"
							...
							>
								...
								window. Follow the on-screen instructions to proceed. You may be
								asked to agree to terms of use, select an installation location,
								or choose additional settings during this process.
							</Typography>
							<Typography level="body-md">
							...
							<Typography
								...
								sx={{ textAlign: "justify" }}
							>
								After following all the instructions, wait until the program is
								completely installed on your system. This may take a few minutes
							...
							<Typography
								...
								sx={{ textAlign: "justify" }}
							>
								After the installation is completed successfully, you should see
								a program icon on your desktop or in the applications menu.
					...
					>
						...
						<Box sx={{ width: "90%", mb: 5 }}>
							...
							<Typography
								...
								sx={{ textAlign: "justify" }}
							>
								To recover your login, enter your e-mail address below and we'll
								send you your registration details.
							</Typography>
							<FormControl>
